...
" Do You have a problem you can find your solution here."<b></i></pre></div>
    ...
    <div class="bottomdiv">
        <p> Copyrights @2024 and Developed by A.LAHARI(212223230111)
</body>
<html>
```
```
...
<body background="backk.png">
    <div class="header">
        <nav id="nav">
            <h1 class="heading1">MSCL SOLUTIONS</h1>
                <ul>
                    <li class="li1"> 
                        <a href="home.html" target="_blank">Home  |</a>
                    </li>
    ...
    <div class="bottomdiv">
        <b>Copyrights @2024 and Developed by A.LAHARI(212223230111)</b>
    </div>
</body>
</html>
```
...
<body>
    <div class="header">
        ...
        <table class="person">
            <tr>
                ...
                <td>
                    <img src="prabhas.jpg" width="100" height="160">
                </td>
		
                <td>
                   <img src="ram.jpg" width="100" height="160">
                </td>
                <td>
                    <img src="nani.jpg" width="100" height="160" >
                </td>
                <td>
                    <img src="saipallavi.jpg" width="100" height="160">
                </td>
            </tr>
            <tr>
                <td>
    ...
    <div class="bottomdiv">
<p>Copyrights @2024 and Developed by A.LAHARI(212223230111)</p>
    </div>
</body>
</html>
```
...
```
## OUTPUT:
![Screenshot 2024-05-06 225925](https://github.com/AnnaLahari/softweb/assets/149365425/2c692afa-2fe4-4fbc-8736-1e681a9a6669)

![Screenshot 2024-05-06 225938](https://github.com/AnnaLahari/softweb/assets/149365425/3266cd97-68b9-47a9-862d-3fac46d04b5e)

![Screenshot 2024-05-06 225951](https://github.com/AnnaLahari/softweb/assets/149365425/6821d359-9db5-4cff-ba84-7f34af34981c)

![Screenshot 2024-05-06 230007](https://github.com/AnnaLahari/softweb/assets/149365425/723ed954-e8ad-40e2-a6bf-25e3d4af6897)
